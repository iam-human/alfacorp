...
<section class="text-white pt-40 lg:pt-48 pb-20 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0 mt-8 md:mt-0 text-center md:text-left">
        <div>
            ...
            <h1 class="text-3xl md:text-5xl lg:text-6xl font-heading font-black text-white drop-shadow-sm tracking-tight">Hubungi Kami</h1>
        </div>
        <div class="flex items-center gap-2 text-white/90 font-semibold text-sm sm:text-base relative z-10 bg-white/10 px-5 py-2.5 rounded-2xl backdrop-blur-md border border-white/20 shadow-lg">
            ...
            <span class="font-bold text-white">Hubungi Kami</span>
        </div>
    </div>
</section>
...
<section class="h-96 w-full bg-slate-200 relative">
    ...
    {{-- Custom Overlay Card --}}
    <div class="absolute top-6 left-1/2 -translate-x-1/2 md:left-6 md:translate-x-0 bg-white dark:bg-gray-900 p-5 rounded-2xl shadow-2xl border border-slate-100 dark:border-gray-800 z-20 w-[calc(100%-3rem)] sm:w-auto max-w-xs md:max-w-sm pointer-events-auto">
