    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
                ...
                <h2 class="text-3xl font-heading font-bold mb-6">Inovasi yang Mengubah Cara Bisnis Bekerja</h2>
...
<section class="py-20 bg-surface-alt">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="bg-white p-10 rounded-2xl shadow-sm border border-slate-100 text-center hover:shadow-md transition-shadow">
                ...
                <h3 class="text-2xl font-heading font-bold mb-4">Visi Kami</h3>
                <p class="text-neutral-600">Menjadi mitra transformasi digital paling terpercaya yang mendorong inovasi dan pertumbuhan berkelanjutan bagi bisnis di seluruh dunia.</p>
            </div>
            <div class="bg-white p-10 rounded-2xl shadow-sm border border-slate-100 text-center hover:shadow-md transition-shadow">
                ...
                <h3 class="text-2xl font-heading font-bold mb-4">Misi Kami</h3>
                <p class="text-neutral-600">Menyediakan solusi teknologi inovatif, memberdayakan bisnis melalui desain solutif, dan memberikan nilai tambah melalui kolaborasi strategis dengan klien.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div>
                <h4 class="text-xl font-bold mb-3 text-slate-900">Integritas</h4>
                <p class="text-neutral-500">Kami menjunjung tinggi kejujuran, transparansi, dan etika profesional dalam setiap interaksi dan layanan.</p>
            </div>
            <div>
                <h4 class="text-xl font-bold mb-3 text-slate-900">Inovasi</h4>
                <p class="text-neutral-500">Kami tidak pernah berhenti belajar dan selalu mencari cara baru yang lebih efektif dan efisien.</p>
            </div>
            <div>
                <h4 class="text-xl font-bold mb-3 text-slate-900">Kolaborasi</h4>
                <p class="text-neutral-500">Kerja sama tim yang kuat dan hubungan kemitraan dengan klien adalah kunci kesuksesan bersama.</p>
            </div>
        </div>
    </div>
</section>
