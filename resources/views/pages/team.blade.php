...
<section class="bg-primary text-white pt-40 lg:pt-48 pb-20 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <h1 class="text-4xl md:text-5xl font-heading font-bold mb-4">Tim Kami</h1>
        <p class="text-primary-light text-lg max-w-2xl mx-auto">Para profesional berpengalaman yang siap membantu mewujudkan setiap kesuksesan proyek digital Anda.</p>
    </div>
</section>
